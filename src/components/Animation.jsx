import img from '../assets/Animation.png'; // Correct image import

function Animation() {
    return (
        <>
            <div className="flex flex-col lg:flex-row items-center justify-between px-5 lg:px-20 py-10 gap-10 font-sans">
                {/* Text Section */}
                ...
                <div className="w-full lg:w-1/2">
                    <img
                        src={img} // Use the imported img here
